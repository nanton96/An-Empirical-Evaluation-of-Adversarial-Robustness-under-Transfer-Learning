...
python train.py --batch_size 128 --continue_from_epoch -1 --seed 0 \
						      --adv_train True --use_e_distr True --label_leaking_prevention True --model densenet121 \
                                                      --num_epochs 200 --adversary "fgsm"  --experiment_name 'densenet121_cifar10_fgsm_ll' \
